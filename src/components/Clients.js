...
const Clients = () => {
  return (
    <div>
      <div className='container mt-32 2xl:mt-24 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full'>
            ...
            <div className='w-full border border-nav p-16 lg:px-32 lg:py-20 lg:space-x-32 flex justify-center lg:justify-start flex-wrap lg:flex-nowrap'>
              ...
              <div className='flex flex-wrap justify-center text-center lg:text-left lg:block'>
                ...
                <p className='text-secondary'>
                  I’ve had the pleasure of working with multiple Fortune 500
                  companies, designing and implementing both frontend and
                  backend.
                </p>
              </div>
            </div>
